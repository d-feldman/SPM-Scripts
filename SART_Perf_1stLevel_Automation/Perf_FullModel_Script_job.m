...
matlabbatch{1}.spm.stats.fmri_spec.sess(1).scans = {
                                                    '/thalia/data/MEND2/RUME19/ImagingData/SubjectsDerived/' subjects '/func/Unresolved/run_01/swr12tr_dc_run_01.nii,' scans
                                                    };
...
matlabbatch{1}.spm.stats.fmri_spec.sess(2).scans = {
                                                    '/thalia/data/MEND2/RUME19/ImagingData/SubjectsDerived/' subjects '/func/Unresolved/run_02/swr12tr_dc_run_02.nii,' scans 
                                                    };
...
matlabbatch{1}.spm.stats.fmri_spec.sess(3).scans = {
                                                    '/thalia/data/MEND2/RUME19/ImagingData/SubjectsDerived/' subjects '/func/Unresolved/run_01/swr12tr_dc_run_03.nii,' scans
                                                    };
